        ...
        <div class="py-2 my-4 rounded-full">
            <form action="{{ route('company.update', $company->id) }}" method="post">
                ...
                <div class="my-4">
                    ...
                    onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Nama Perusahaan...." value="{{ $company->id }}">
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="company_name" name="company_name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Nama Perusahaan...." value="{{ $company->company_name }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="sector" name="sector"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Bidang Perusahaan...." value="{{ $company->sector }}">
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="company_type" name="company_type"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Tipe Perusahaan...." value="{{ $company->company_type }}">
                        </div>
                        <div class="w-full">
                            <label for="address"
                            ...
                            <textarea type="text" id="address" name="address"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Alamat Perusahaan...." value="{{ $company->address }}">{{ $company->address }}</textarea>
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="city" name="city"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan City Perusahaan...." value="{{ $company->city }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="email" id="email" name="email"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                 placeholder="Isi dengan Email Perusahaan...." value="{{ $company->email }}">
                        </div>
                        <div class="w-full">
                            <label for="fax"
                            ...
                            <input type="text" id="fax" name="fax"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan FAX Perusahaan...." value="{{ $company->fax }}">
                        </div>
                        <div class="w-full">
                            <label for="kode_pos"
                            ...
                            <input type="text" id="kode_pos" name="kode_pos"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Kode Pos Perusahaan...." value="{{ $company->kode_pos }}">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                ...
                                <option value="{{ $company->grade }}">{{ $company->grade }}</option>
                                @switch($company->grade)
                                    @case("INTERNASIONAL")
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="pic" name="pic"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Kontak Person Perusahaan...." value="{{ $company->pic }}">
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="position" name="position"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Jabatan Kontak Person Perusahaan...." value="{{ $company->position }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="phone_number" name="phone_number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Telepon Perusahaan...." value="{{ $company->phone_number }}">
                        ...
                        <div class="w-full">
                            ...
                            <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                ...
                                <option value="{{ $company->relation }}">{{ $company->relation }}</option>
                                @switch( $company->relation )
                                    @case("LAMA")
                        ...
                        <div class="w-full">
                            ...
                            <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                ...
                                <option value="{{ $company->mou }}">{{ $company->mou }}</option>
                                @switch($company->mou)
                                    @case("SUDAH")
