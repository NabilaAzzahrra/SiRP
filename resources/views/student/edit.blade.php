            ...
            <form action="{{ route('student.update',  $student->nim) }}" method="post">
                ...
                <div class="my-4">
                    ...
                    <div class="flex gap-4 my-4">
                        ...
                        <div class="w-full">
                            <label for="link_berkas"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Berkas
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="link_berkas" name="link_berkas"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()" placeholder="Isi dengan Link Berkas...."
                                value="{{ $student->link_berkas }}">
                            <span class="text-sm m-l text-red-500">{{ $errors->first('link_berkas') }}</span>
                        </div>
                        <div class="w-full">
                            ...
                            <input type="text" id="student_name" name="student_name"
                                ...
                                placeholder="Isi dengan Nama Lengkap Mahasiswa...."
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                ...
                                <option value="{{ $student->id_class }}">{{ $student->classes->class_name }}</option>
                                @foreach ($classes as $c)
                                    @if ($c->id != $student->id_class)
                        ...
                        <div class="w-full" id="prodi">
                            ...
                            <input type="text" id="major" name="major"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Isi dengan Bidang Perusahaan...." value="{{ $student->classes->major->major }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="financial_status" name="financial_status"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Status Keuangan...."
                                value="{{ $student->financial_status }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="academic_counselors" name="academic_counselors"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Pembimbing Akademik...."
                                value="{{ $student->academic_counselors }}">
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="request_recruitment" name="request_recruitment"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Request Penempatan...."
                                value="{{ $student->request_recruitment }}">
                        ...
                        <div class="w-full">
                            ...
                            <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                ...
                                @php
                                    $gen = $student->gender == 'P' ? 'PEREMPUAN' : 'LAKI-LAKI';
                                @endphp

                                <option value="{{ $student->gender }}">{{ $gen }}</option>
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="place_of_birth" name="place_of_birth"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan tempat lahir...." value="{{ $student->place_of_birth }}">
                        </div>
                        <div class="w-full">
                            ...
                            <input type="date" id="date_of_birth" name="date_of_birth"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Kode Pos Perusahaan...."
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" id="age" name="age"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Kode Pos Perusahaan...." value="{{ $student->age }}">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="hamlet" name="hamlet"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Kode Pos Perusahaan...." value="{{ $student->hamlet }}">
                        </div>
                        <div class="w-full">
                            <label for="village"
                            ...
                            <input type="text" id="village" name="village"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Desa/Kelurahan...." value="{{ $student->village }}">
                        </div>
                        <div class="w-full">
                            <label for="city"
                            ...
                            <input type="text" id="city" name="city"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Kota/Kabupaten...." value="{{ $student->city }}">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="phone_number" name="phone_number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Nomor Handphone...." value="{{ $student->phone_number }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="parents_name" name="parents_name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Nama Orang Tua...." value="{{ $student->parents_name }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="parents_job" name="parents_job"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Pekerjaan Orang Tua...." value="{{ $student->parents_job }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="parents_phone" name="parents_phone"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan No Handphone Orang Tua...."
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="competence_test1" name="competence_test1"
                                ...
                                value="{{ $student->competence_test1 }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="competence_test2" name="competence_test2"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Uji Kompetensi 2...."
                                value="{{ $student->competence_test2 }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="competence_test3" name="competence_test3"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Uji Kompetensi 3...."
                                value="{{ $student->competence_test3 }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="competence_test4" name="competence_test4"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Uji Kompetensi 4...."
                                value="{{ $student->competence_test4 }}">
                    ...
                    <div class="flex gap-4 my-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="high_school" name="high_school"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Asal Sekolah...." value="{{ $student->high_school }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="major_high_school" name="major_high_school"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Jurusan Sekolah...."
                                value="{{ $student->major_high_school }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="class_year" name="class_year"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Tahun Angkatan...." value="{{ $student->class_year }}">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="graduation_year" name="graduation_year"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onkeyup="this.value = this.value.toUpperCase()"
                                placeholder="Isi dengan Tahun Lulus...." value="{{ $student->graduation_year }}">
