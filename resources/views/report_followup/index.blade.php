    ...
    @push('scripts')
        ...
        <script>
            const changeFilterDataRegisterProgram = () => {
                ...
                urlItemDetail = `/api/followup?${queryString}`;
                ...
                if (dataTableDataRegisterProgramInstance) {
                    ...
                    getDataTableRegisterProgram()
                        .then((response) => {
                            dataTableDataRegisterProgramInstance = $('#followup-datatable').DataTable(response.config);
            ...
            const getDataTableRegisterProgram = async () => {
                return new Promise(async (resolve, reject) => {
                    try {
                        ...
                        let registers = response.data.followup;
                        ...
                        let columnConfigs = [{
                            ...
                            },
                            {
                                ...
                                data: 'company',
                                render: (data, type, row) => {
                                    return `<span class="text-wrap">${data.sector}</span>`;
                                }
                            }, {
                                data: 'company',
                                render: (data, type, row) => {
            ...
            const promiseDataRegisterProgram = () => {
                ...
                Promise.all([
                    ...
                    .then((response) => {
                        ...
                        dataTableDataRegisterProgramInstance = $('#followup-datatable').DataTable(
                            responseDTRS
                            .config);
